...
/**
 * An immutable class that encapsulates a set of MaxEnt command line options. A
 * configuration cannot contain duplicate options. Each option has at most one
 * value. It is not designed for inheritance and is therefore prohibited.
 * 
